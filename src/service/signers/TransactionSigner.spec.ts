...
import { LocalWalletSignerProvider } from './SignerProvider';
...
describe('Testing TransactionSigner', () => {
  it('test transfer transaction signing ', async () => {
    ...
    const signerProvider = new LocalWalletSignerProvider(phrase, testNetConfig.derivationPath);
    const signer = new TransactionSigner(testNetConfig, signerProvider);
